...
-- "Jäger" / "Bomber" --
model = ModelData()
model:setName("terra_jaeger")
model:setMesh("terra_jaeger.obj")
model:setTexture("terra_jaeger.png")
model:setScale(15)
model:setRadius(30)
model:addEngineEmitter(-1, 0, 0,  1.0, 0.2, 0.1, 1.0)

model = ModelData()
model:setName("terra_bomber")
model:setMesh("terra_bomber.obj")
model:setTexture("terra_bomber.png")
model:setScale(15)
model:setRadius(30)
model:addEngineEmitter(-1, 0, 0,  0.0, 1.0, 0.5, 1.0)
model:addEngineEmitter(0, 2, 0,  0.0, 1.0, 0.5, 0.5)
model:addEngineEmitter(0, -2, 0,  0.0, 1.0, 0.5, 0.5)

model = ModelData()
model:setName("terra_aufklaerer")
model:setMesh("terra_aufklaerer.obj")
model:setTexture("terra_aufklaerer.png")
model:setScale(10)
model:setRadius(20)
model:addEngineEmitter(-1, 0, 0,  0.0, 1.0, 0.5, 1.0)
model:addEngineEmitter(-0.2, -1.5, 0,  0.0, 1.0, 0.5, 0.5)

-- "Kleinere Schiffstypen" --
model = ModelData()
model:setName("terra_tarnschiff")
model:setMesh("terra_tarnschiff.obj")
model:setTexture("terra_tarnschiff.png")
model:setScale(30)
model:setRadius(50)
model:addEngineEmitter(-1, 0, 0,  0.0, 2.0, 0.2, 1.2)

model = ModelData()
model:setName("terra_minenleger")
model:setMesh("terra_minenleger.obj")
model:setTexture("terra_minenleger.png")
model:setScale(30)
model:setRadius(40)
model:addEngineEmitter(-1.5, -2, 0,  0.0, 2.0, 0.2, 1.0)
model:addEngineEmitter(-1.5, 2, 0,  0.0, 2.0, 0.2, 1.0)

model = ModelData()
model:setName("terra_kanonenboot")
model:setMesh("terra_kanonenboot.obj")
model:setTexture("terra_kanonenboot.png")
model:setScale(30)
model:setRadius(40)
model:addEngineEmitter(-1.2, 0, 0,  0.0, 2.0, 0.2, 2.0)


-- "Mittlere Schiffstypen" --
model = ModelData()
model:setName("terra_korvette")
model:setMesh("terra_korvette.obj")
model:setTexture("terra_korvette.png")
model:setScale(60)
model:setRadius(150)
model:addEngineEmitter(-3.5, 0, 0,  0.0, 0.5, 2.0, 2.0)

model = ModelData()
model:setName("terra_fregatte")
model:setMesh("terra_fregatte.obj")
model:setTexture("terra_fregatte.png")
model:setScale(60)
model:setRadius(180)
model:addEngineEmitter(-4.2, 0.1, 0.6,  0.0, 0.5, 2.0, 2.5)
model:addEngineEmitter(-3.5, -1.5, 0.4,  0.0, 0.5, 2.0, 1)

model = ModelData()
model:setName("terra_zerstoerer")
model:setMesh("terra_zerstoerer.obj")
model:setTexture("terra_zerstoerer.png")
model:setScale(120)
model:setRadius(300)
model:setCollisionBox(420, 100)
model:addEngineEmitter(-2.5, 0, 0,  0.0, 0.5, 2.0, 2.5)


model = ModelData()
model:setName("terra_zerstoerer2")
model:setMesh("terra_zerstoerer2.obj")
model:setTexture("terra_zerstoerer2.png")
model:setScale(100)
model:setRadius(300)
model:setCollisionBox(440, 100)
model:addEngineEmitter(-3.5, 0, 0,  0.0, 0.5, 2.0, 2.5)

-- "Schwere Schiffstypen" --
model = ModelData()
model:setName("terra_kreuzer")
model:setMesh("terra_kreuzer.obj")
model:setTexture("terra_kreuzer.png")
model:setScale(90)
model:setRadius(300)
model:setCollisionBox(440, 150)
model:addEngineEmitter(-3.5, 0, 0,  0.0, 0.5, 2.0, 2.5)

model = ModelData()
model:setName("terra_schlachtkreuzer")
model:setMesh("terra_schlachtkreuzer.obj")
model:setTexture("terra_schlachtkreuzer.png")
model:setScale(140)
model:setRadius(400)
model:setCollisionBox(600, 250)
model:addEngineEmitter(-3.5, 0, 0,  0.0, 0.5, 2.0, 3)

model = ModelData()
model:setName("terra_schlachtkreuzer2")
model:setMesh("terra_schlachtkreuzer2.obj")
model:setTexture("terra_schlachtkreuzer2.png")
model:setScale(120)
model:setRadius(400)
model:setCollisionBox(700, 250)
model:addEngineEmitter(-3.6, 0, 0,  0.0, 0.5, 2.0, 3)

model = ModelData()
model:setName("terra_schlachtschiff")
model:setMesh("terra_schlachtschiff.obj")
model:setTexture("terra_schlachtschiff.png")
model:setScale(200)
model:setRadius(650)
model:setCollisionBox(1300, 400)
model:addEngineEmitter(-4, 0, 0,  0.0, 0.5, 2.0, 3,5)
model:addEngineEmitter(0.5, -1.9, 0,  0.0, 0.5, 2.0, 1)
model:addEngineEmitter(0.5, 1.9, 0,  0.0, 0.5, 2.0, 1)

model = ModelData()
model:setName("terra_schlachtschiff2")
model:setMesh("terra_schlachtschiff2.obj")
model:setTexture("terra_schlachtschiff2.png")
model:setScale(160)
model:setRadius(800)
model:setCollisionBox(1500, 400)
model:addEngineEmitter(-3.5, 0, 1,  0.0, 0.5, 2.0, 1)
model:addEngineEmitter(-3.5, 0.4, 0,  0.0, 0.5, 2.0, 1)
model:addEngineEmitter(-3.5, 0, -1,  0.0, 0.5, 2.0, 1)
model:addEngineEmitter(-6, 0, 0,  0.0, 0.5, 2.0, 3)


model = ModelData()
model:setName("terra_traeger")
model:setMesh("terra_traeger.obj")
model:setTexture("terra_traeger.png")
model:setScale(150)
model:setRadius(650)
model:setCollisionBox(1200, 400)
model:addEngineEmitter(1.7, 1.5, 0.2,  0.0, 0.5, 2.0, 1.5)
model:addEngineEmitter(1.7, -1.5, 0.2,  0.0, 0.5, 2.0, 1.5)
model:addEngineEmitter(-4, 0, 0,  0.0, 0.5, 2.0, 3)

-- "Hilfs-Schiffstypen" --
model = ModelData()
model:setName("terra_tender")
model:setMesh("terra_tender.obj")
model:setTexture("terra_tender.png")
model:setScale(140)
model:setRadius(650)
model:setCollisionBox(1200, 400)
