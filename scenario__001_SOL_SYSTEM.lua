...
function init()
	...
	Transport_4=    CpuShip():setFaction("Unabhängige"):setTemplate("Transport3x1"):setCallSign("UH XX-X4"):setPosition(138813,45781):orderRoaming()
	...
	Transport_9=    CpuShip():setFaction("Unabhängige"):setTemplate("Garbage Freighter 2"):setCallSign("UH CD-22"):setPosition(52352,60806):orderDock(marsstation1):setCommsFunction(CD_22_9_call)
...
function ER_10_8_call() -- Script für Transport 8 -- Alienübernahme
	...
	if ER_10_8 == 1 and ER_10_8_hack == 1 then
		...
		addCommsReply("Hätten sie für uns einen Auftrag?.",function()
