function init()
	carrier_01 = CpuShip():setFaction("Terranische Navy"):setTemplate("Träger"):setCallSign("TN Gomorra"):setPosition(10556, -27333):orderRoaming():setWeaponStorage("Nuke", 0):setWarpDrive(true)
...
function ki_carrier()
	if carrier_01:areEnemiesInRange(4000) then
		...
		fighterkic1_01=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Jäger"):setCallSign("TNGJ 01"):setScanned(true):setPosition(xjc_01+500,yjc_01+500):orderDefendTarget(carrier_01)
		carrier_01.fighterkic1_01carrier = 0
		end
		if carrier_01.fighterkic1_02carrier == 1 then
		fighterkic1_02=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Jäger"):setCallSign("TNGJ 02"):setScanned(true):setPosition(xjc_01-500,yjc_01+500):orderDefendTarget(carrier_01)
		carrier_01.fighterkic1_02carrier = 0
		end
		if carrier_01.fighterkic1_03carrier == 1 then
		fighterkic1_03=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Jäger"):setCallSign("TNGJ 03"):setScanned(true):setPosition(xjc_01+500,yjc_01-500):orderDefendTarget(carrier_01)
		carrier_01.fighterkic1_03carrier = 0
		end
		if carrier_01.fighterkic1_04carrier == 1 then
		fighterkic1_04=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Jäger"):setCallSign("TNGJ 04"):setScanned(true):setPosition(xjc_01-500,yjc_01-500):orderDefendTarget(carrier_01)
		carrier_01.fighterkic1_04carrier = 0
		end
		if carrier_01.fighterkic1_05carrier == 1 then
		fighterkic1_05=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Jäger"):setCallSign("TNGJ 05"):setScanned(true):setPosition(xjc_01+500,yjc_01):orderDefendTarget(carrier_01)
		carrier_01.fighterkic1_05carrier = 0
		end
		if carrier_01.fighterkic1_06carrier == 1 then
		fighterkic1_06=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Jäger"):setCallSign("TNGJ 06"):setScanned(true):setPosition(xjc_01-500,yjc_01):orderDefendTarget(carrier_01)
	...
	if carrier_01:areEnemiesInRange(5000) then
		...
		bomberkic1_01=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Bomber"):setCallSign("TNGB 01"):setScanned(true):setPosition(xbc_01+500,ybc_01+500):orderDefendTarget(carrier_01)
		carrier_01.bomberkic1_01carrier = 0
		end
		if carrier_01.bomberkic1_02carrier == 1 then
		bomberkic1_02=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Bomber"):setCallSign("TNGB 02"):setScanned(true):setPosition(xbc_01-500,ybc_01+500):orderDefendTarget(carrier_01)
		carrier_01.bomberkic1_02carrier = 0
		end
		if carrier_01.bomberkic1_03carrier == 1 then
		bomberkic1_03=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Bomber"):setCallSign("TNGB 03"):setScanned(true):setPosition(xbc_01+500,ybc_01-500):orderDefendTarget(carrier_01)
		carrier_01.bomberkic1_03carrier = 0
		end
		if carrier_01.bomberkic1_04carrier == 1 then
		bomberkic1_04=	CpuShip():setFaction(carrier_01:getFaction()):setTemplate("Bomber"):setCallSign("TNGB 04"):setScanned(true):setPosition(xbc_01-500,ybc_01-500):orderDefendTarget(carrier_01)
