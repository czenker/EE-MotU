...
template:setWeaponStorage("HVLI", 80)
...
template:setBeam(0, 90, 90, 1400, 22, 150)
template:setBeam(1, 90, -90, 1400, 22, 150)
template:setBeam(2, 90, 0, 1400, 22, 150)
...
template:setTubeDirection(1,-15):setWeaponTubeExclusiveFor(1, "Homing"):setTubeLoadTime(1, 15)
template:setTubeDirection(2, 15):setWeaponTubeExclusiveFor(2, "Homing"):setTubeLoadTime(2, 15)
template:setTubeDirection(3,-30):setWeaponTubeExclusiveFor(3, "Homing"):setTubeLoadTime(3, 10)
template:setTubeDirection(4, 30):setWeaponTubeExclusiveFor(4, "Homing"):setTubeLoadTime(4, 10)
...
template:setBeam(0, 90, 90, 1200, 20, 90)
template:setBeam(1, 90, -90, 1200, 20, 90)
template:setBeam(2, 90, 0, 1200, 20, 90)
template:setTubes(4, 12.0)
template:setWeaponStorage("Homing", 30)
template:setWeaponStorage("HVLI", 30)
template:setTubeDirection(1,-20):setWeaponTubeExclusiveFor(1, "Homing"):setTubeLoadTime(1, 20)
template:setTubeDirection(2, 20):setWeaponTubeExclusiveFor(2, "Homing"):setTubeLoadTime(2, 20)
template:setTubeDirection(3,-70):setWeaponTubeExclusiveFor(3, "HVLI"):setTubeLoadTime(3, 10)
template:setTubeDirection(4, 70):setWeaponTubeExclusiveFor(4, "HVLI"):setTubeLoadTime(4, 10)
...
template:setBeam(0, 90, 90, 1200, 20, 80)
template:setBeam(1, 90, -90, 1200, 20, 80)
template:setBeam(2, 90, 0, 1200, 20, 80)
template:setTubes(4, 15.0)
template:setWeaponStorage("HVLI", 30)
template:setWeaponStorage("Homing", 20)
template:setTubeDirection(0, 5):setWeaponTubeExclusiveFor(0, "HVLI")
template:setTubeDirection(1,-5):setWeaponTubeExclusiveFor(1, "HVLI")
template:setTubeDirection(2, 20):setWeaponTubeExclusiveFor(2, "Homing")
template:setTubeDirection(3,-20):setWeaponTubeExclusiveFor(3, "Homing")
...
template:setHull(175)
template:setWarpSpeed(900)
template:setShields(110, 110)
template:setSpeed(90, 11, 30)
template:setBeam(0, 180, 90, 1200, 15, 50) -- HIER MUSS ICH NOCH DRAN SCHRAUBEN VERDAMMTE SCHEIßE!!!!
template:setBeam(1, 180, -90, 1200, 15, 50)
template:setBeam(2, 180, 90, 1200, 2, 2) -- HIER MUSS ICH NOCH DRAN SCHRAUBEN VERDAMMTE SCHEIßE!!!!
template:setBeam(3, 180, -90, 1200, 2, 2)
...
template:setShields(110, 110)
template:setSpeed(90, 11, 30)
template:setBeam(0, 180, 90, 1200, 15, 50)
template:setBeam(1, 180, -90, 1200, 15, 50)
template:setBeam(2, 180, 90, 1200, 2, 2)
template:setBeam(3, 180, -90, 1200, 2, 2)
...
template:setBeam(0, 100, 50, 1050, 15, 30)
template:setBeam(1, 100, -50, 1050, 15, 30)
template:setBeam(2, 60, 0, 1050, 15, 30)
...
template:setBeam(1, 100, 50, 1000, 10, 25)
template:setBeam(2, 100, -50, 1000, 10, 25)
template:setBeam(3, 60, 0, 1000, 10, 25)
...
template:setBeam(0, 60, 70, 800, 6, 8)
template:setBeam(1, 60, 110, 800, 6, 8)
template:setBeam(2, 60, 90, 800, 4, 6)
template:setBeam(3, 60, -70, 800, 6, 8)
template:setBeam(4, 60, -110, 800, 6, 8)
template:setBeam(5, 60, -90, 800, 4, 6)
...
template:setSpeed(90, 10, 25)
template:setBeam(0, 20, 0, 800, 4, 10)
template:setBeam(1, 40, 0, 800, 6, 10)
...
-- "Erfarmer" -- 1
template = ShipTemplate():setName("Erzfarmer"):setClass("Corvette", "Auxilliar"):setModel("terra_erzfarmer")
template:setRadarTrace("radar_erzer.png")
template:setHull(50)
