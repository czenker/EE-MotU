...
template:setBeam(0, 90, 90, 1400, 25, 150)
template:setBeam(1, 90, -90, 1400, 25, 150)
template:setBeam(2, 90, 0, 1400, 25, 150)
...
template:setShields(500, 500, 500, 500)
template:setSpeed(60, 6, 15)
template:setBeam(0, 90, 90, 1400, 25, 120)
template:setBeam(1, 90, -90, 1400, 25, 120)
template:setBeam(2, 90, 0, 1400, 25, 130)
template:setTubes(5, 14.0)
template:setWeaponStorage("Nuke", 5)
template:setWeaponStorage("Homing", 40)
template:setTubeDirection(0, 0):setWeaponTubeExclusiveFor(0, "Nuke"):setTubeLoadTime(0, 60)
...
template:setBeam(0, 90, 90, 1200, 24, 80)
template:setBeam(1, 90, -90, 1200, 24, 80)
template:setBeam(2, 90, 0, 1200, 24, 90)
...
template:setBeam(0, 90, 90, 1200, 20, 70)
template:setBeam(1, 90, -90, 1200, 20, 70)
...
template:setSpeed(75, 9, 20)
template:setBeam(0, 90, 50, 1050, 15, 25)
template:setBeam(1, 90, -50, 1050, 15, 25)
...
template:setBeam(1, 90, 50, 1000, 8, 10)
template:setBeam(2, 90, -50, 1000, 8, 10)
template:setBeam(3, 60, 0, 1000, 8, 20)
...
template:setBeam(0, 60, 70, 800, 8, 5)
template:setBeam(1, 60, 110, 800, 8, 5)
template:setBeam(2, 60, -70, 800, 8, 5)
template:setBeam(3, 60, -110, 800, 8, 5)
